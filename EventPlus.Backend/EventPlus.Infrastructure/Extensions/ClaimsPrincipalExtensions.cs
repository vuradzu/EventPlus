...
namespace EventPlus.Infrastructure.Extensions;
...
public static class ClaimsPrincipalExtensions
{
    ...
    /// <exception cref="ForbidException">Throws when the user is not authenticated</exception>
    /// <exception cref="UnauthorizedException">Throws when the user is doesn't have a claim with given type</exception>
